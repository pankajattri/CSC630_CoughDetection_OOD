...
dataset = AudioDataset(raw_data_dir,window_length,sr,'test',
                           normalize = False, only_speech = False)
...
if __name__ == '__main__':
    ...
    metrics_path = 'results/test/{}s_{}Hz_{}epochs.csv'.format(str(window_length).replace('.','-'),
                                                               sr,num_epochs)
